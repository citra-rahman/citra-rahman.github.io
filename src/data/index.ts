...
export const experiences = [
  {
    ...
    description: [
      "Strategic communication and project management within the digital landscape before pivoting to technical engineering.",
    ],
  ...
  },
  {
    ...
    description: [
      "Collaborating with international clients to deliver high-end bespoke web solutions and architectural consulting. ",
    ],
